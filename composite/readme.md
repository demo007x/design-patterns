...
![组合设计模式](https://refactoringguru.cn/images/patterns/content/composite/composite.png)
...
![部队结构的例子](https://refactoringguru.cn/images/patterns/diagrams/composite/live-example.png)
