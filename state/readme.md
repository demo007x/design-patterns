...
![状态设计模式](https://demo007x-articles.oss-cn-beijing.aliyuncs.com/demo007x-articles/202306201035800.png)

##  问题

状态模式与**有限状态机** 的概念紧密相关。

![有限状态机](https://demo007x-articles.oss-cn-beijing.aliyuncs.com/demo007x-articles/202306201035855.png)
...
![文档对象的全部状态](https://demo007x-articles.oss-cn-beijing.aliyuncs.com/demo007x-articles/202306201036665.png)
...
![文档将工作委派给一个状态对象](https://demo007x-articles.oss-cn-beijing.aliyuncs.com/demo007x-articles/202306201041002.png)
...
![状态模式示例的结构](https://refactoringguru.cn/images/patterns/diagrams/state/example.png)
