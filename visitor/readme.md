...
![访问者设计模式](https://demo007x-articles.oss-cn-beijing.aliyuncs.com/demo007x-articles/202306201535566.png)
...
![将图像导出为 XML](https://demo007x-articles.oss-cn-beijing.aliyuncs.com/demo007x-articles/202306201535243.png)
...
![所有节点的类中都必须添加导出至 XML 文件的方法](https://demo007x-articles.oss-cn-beijing.aliyuncs.com/demo007x-articles/202306201539895.png)
