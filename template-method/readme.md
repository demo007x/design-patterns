...
![模板方法设计模式](https://demo007x-articles.oss-cn-beijing.aliyuncs.com/demo007x-articles/202306201138927.png)
...
![数据挖掘类包含许多重复代码](https://demo007x-articles.oss-cn-beijing.aliyuncs.com/demo007x-articles/202306201138449.png)
...
![模板方法定义了算法的框架](https://refactoringguru.cn/images/patterns/diagrams/template-method/solution-zh.png)
...
![建造大型房屋](https://refactoringguru.cn/images/patterns/diagrams/template-method/live-example.png)
...
![模板方法模式示例的结构](https://refactoringguru.cn/images/patterns/diagrams/template-method/example.png)
