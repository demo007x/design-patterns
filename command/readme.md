...
![命令设计模式](https://refactoringguru.cn/images/patterns/content/command/command-zh.png)
...
![GUI 层可以直接访问业务逻辑层](https://refactoringguru.cn/images/patterns/diagrams/command/solution1-zh.png)
...
![通过命令访问业务逻辑层。](https://refactoringguru.cn/images/patterns/diagrams/command/solution2-zh.png)
...
![GUI 对象将命令委派给命令对象](https://refactoringguru.cn/images/patterns/diagrams/command/solution3-zh.png)
...
![在餐厅里点餐](https://refactoringguru.cn/images/patterns/content/command/command-comic-1.png)
...
![命令模式示例的结构](https://refactoringguru.cn/images/patterns/diagrams/command/example.png)
